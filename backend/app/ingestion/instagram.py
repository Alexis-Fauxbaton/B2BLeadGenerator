...
_PRESCRIBER_SYSTEM = (
    ...
    "DESIGN-BUILD (hors_cible) : celui qui à la fois CONÇOIT ET FABRIQUE/INSTALLE "
    "LUI-MÊME ce qu'il vend est hors_cible, MÊME s'il s'auto-déclare « architecte "
    "d'intérieur ». Signaux : bio/catégorie « magasin d'ameublement / de meubles / "
    "boutique de décoration », et/ou posts RÉCURRENTS de sa PROPRE réalisation — "
    "« réalisation sur mesure », « installation », « fabrication », « posé/réalisé "
    "par nous » — de ce qu'il vend (cuisines, meubles, agencement). Il vend son "
    "produit, il ne prescrit pas celui d'un fournisseur tiers.\n"
